...
class CurevedLine extends StatelessWidget {
  const CurevedLine({Key? key, this.y}) : super(key: key);
...
class _MovingCurvedCliper extends CustomClipper<Path> {
  ...
  Path getClip(Size size) {
    double unit = size.height / 100;

    double deltaY = -(52 - centerY! / unit) * unit;
    return Path()
      ..moveTo(
        unit * 4.49826,
        unit * 45.4994 + deltaY,
